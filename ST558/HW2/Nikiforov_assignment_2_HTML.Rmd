...
The four _core_ packages that we’ll use the most are given below along with their purpose and a quick example
of some functionality.

## dplyr

```{r dplyr_graphic, echo=FALSE, out.width = "25%", fig.align='center'}
...
```{r ggplot2_graphic, echo=FALSE, out.width = "25%", fig.align='center'}
...
```{r readr_graphic, echo=FALSE, out.width = "25%", fig.align='center'}
...
```{r tidyr_graphic, echo=FALSE, out.width = "25%", fig.align='center'}
