...
**Q:** If your working directory is myfolder/homework/, what path would you specify to get the file located at myfolder/MyData.csv?

**A:**   

### 2. 

**Q.** Read in the BreastCancer.dat data file. (Open the file in a program such as notepad or wordpad to determine the delimiter - although a program like notepad++ is a better choice.) Save the data to an R object called cancerData.
